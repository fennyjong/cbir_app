...
# Modified CBIRModel class with min_similarity
class CBIRModel:
    ...
    def find_similar_images(self, query_features, n_results=10):
        ...
        valid_indices = np.where(similarities >= self.min_similarity)[0]  # Filter images based on similarity
...
# # Modified CBIRModel class without min_similarity filter
# class CBIRModel:
